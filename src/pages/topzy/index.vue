      ...
      <div class="zyeitem">
        ...
        <div class="addimg">
          <block v-for="(v, k) in item.imgs" :key="k">
            <div class="addImgHandel" @click="addImg(v, k, key)">
              <block v-if="v.imgSrc">
                <div class="img" :style="{backgroundImage: 'url('+ v.imgSrc +')'}" @click="delImg(item.imgs, key)"></div>
              </block>
              <block v-if="!v.imgSrc">
                <div class="addd">
      ...
      <div class="weui-cells weui-cells_after-title">
        <div class="weui-cell weui-cell_switch">
          ...
          <div class="weui-cell__ft">
            <switch :checked="top" color="#2287D4" @change="topChange" />
          </div>
        </div>
        <div class="weui-cell weui-cell_input" v-if="top">
          <div class="weui-cell__hd">开始时间</div>
          <div class="weui-cell__bd">
            <picker mode="date" start="2018-01-01" end="2099-01-01" :value="startDate" @change="dateChange($event, 'startDate')">
        ...
        <div class="weui-cell weui-cell_input" v-if="top">
          ...
          <div class="weui-cell__bd">
            <picker mode="date" start="2018-01-01" :value="endDate" end="2099-01-01" @change="dateChange($event, 'endDate')">
